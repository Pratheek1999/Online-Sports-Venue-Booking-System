<?php
  ...
  // Database connection
  $conn = new mysqli('localhost', 'root', '', 'ipl_proj');
  ...
  function add()
  {
    ...
    $request = 'INSERT INTO `ven_book` ';
    $request = '(`StartTime`,`EndTime`,`Details`,`Location`,`Resources`,`Contacts`,`Subject`)';
    $request = ' VALUES(';
  ...
  function delete()
  {
    ...
    $item = json_decode($_GET['item']);
    $request = 'DELETE FROM `ven_book` WHERE ';
